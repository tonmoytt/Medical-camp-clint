...
const AboutUs = () => {
    return (
        <div>
            <p>
                Welcome to our Medical Camp Management! We are dedicated to ensuring the well-being of communities through organized and impactful healthcare initiatives. With a passion for public health, our team brings together a wealth of experience in event planning, medical coordination, and community outreach. Our mission is to bridge the gap between healthcare services and those in need by orchestrating well-planned medical camps. These camps serve as a vital platform for health education, preventive screenings, and timely medical interventions. Committed to inclusivity and accessibility, we strive to create a supportive environment where individuals from diverse backgrounds can access essential healthcare services. Join us in our journey to make a positive impact on lives by fostering a culture of health and wellness in every community we touch.
            </p>
            <p>
