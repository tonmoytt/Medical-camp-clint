...
const Contact = () => {
    return (
        <div>
            ...
            <div className="mx-16">
                <p className="mt-10">
                    Certainly! Below is an example of a "Contact Us" page for a Medical Camp Management organization:

                    Contact Us

                    Thank you for your interest in our Medical Camp Management. We are here to assist you and welcome any inquiries, feedback, or collaboration opportunities.</p>
                <p className="mt-6">
                    <p className="text-xl font-semibold">Contact Form:</p>
                    Please use the form below to get in touch with us. Fill in your name, email address, select the subject of your inquiry, and leave a detailed message. We will get back to you as soon as possible.
                </p>
                    ...
                    <p>
                     ...
                     <li>Facebook</li>   
                      ...
                      <li>Instagram</li>   
                        ...
                        If you are interested in collaborating with us, please reach out to our Partnership Coordinator, Ms. Samantha Johnson, at partnerships@medicalcampmanagement.org.
